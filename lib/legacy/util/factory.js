...
function plotRadarGraph(title, blips, currentRadarName, alternativeRadars) {
  if (typeof document !== "undefined") {
    ...
    const graphingRadar = new GraphingRadar(getGraphSize(), radar);
...
export class Factory {
  build(data, config = {}) {
    ...
    try {
      ...
      plotRadarGraph(undefined, blips, undefined, []);
    } catch (error) {
